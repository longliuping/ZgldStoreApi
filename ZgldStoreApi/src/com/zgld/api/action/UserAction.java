...
public class UserAction extends BaseAction {
		...
		try {
			if ((this.form.getName() == null) || (this.form.getName().isEmpty())) {
				...
				if (user != null) {
					...
					Users u = (Users) this.baseService.bean(" from Users as u where u.userId = " + this.form.getId());
					if (u == null) {
	...
	public String update_user_email() {
		...
		try {
			YAccount account = getUserInfo();
			if (account != null) {
				if (this.form.getUserinfo().getAccountEmail() == null) {
	...
	public String update_user_head() {
		...
		try {
			YAccount account = getUserInfo();
			if (account != null) {
				if (this.form.getUserinfo().getAccountHead() == null) {
	...
	public String update_cellphone() {
		...
		try {
			YAccount account = getUserInfo();
			if (account != null) {
				if (this.form.getCellPhone() == null) {
